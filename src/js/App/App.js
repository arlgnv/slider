...
export default class App {
  ...
  update(obj) {
    ...
    const correctedSettings = this.model._correctSettings({ ...currentState, ...obj });
    ...
    if (correctedSettings.theme !== currentState.theme) {
    ...
    if (correctedSettings.isVertical !== currentState.isVertical) {
    ...
    this.model._state = correctedSettings;
