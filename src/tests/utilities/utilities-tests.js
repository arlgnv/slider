    ...
    describe("Functions", () => {
        ...
        describe("correctSettings", () => {
            ...
            it("change type from string to number on 'from, min, max, step, to'", () => {
                const settings = {from: "0",min: "0",max: "100",step: "1",range: true,to:"3",view: "horizontal",hideTip: true,theme: "aqua"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'from' equal 'min' if 'from' less 'min' and 'range' is false", () => {
                const settings = {from: -13,min: 0,max: 100,step: 1,range: false,view: "horizontal",hideTip: true,theme: "aqua"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'from' equal 'max' if 'from' more 'max' and 'range' is false", () => {
                const settings = {from: 101,min: 0,max: 100,step: 1,range: false,view: "horizontal",hideTip: true,theme: "aqua"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'from' equal 'min' if 'range' is true and 'from' less 'min'", () => {
                const settings = {from: 9,min: 10,max: 100,step: 1,range: true,to:20,view: "horizontal",hideTip: true,theme: "asdasdasd"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'from' equal 'to' if 'range' is true and 'from' more 'to'", () => {
                const settings = {from: 16,min: 10,max: 100,step: 1,range: true,to:15,view: "horizontal",hideTip: true,theme: "asdasdasd"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'to' equal 'from' if 'range' is true and 'to' less 'from'", () => {
                const settings = {from: 10,min: 10,max: 100,step: 1,range: true,to:5,view: "horizontal",hideTip: true,theme: "asdasdasd"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'to' equal 'max' if 'range' is true and 'to' more 'max'", () => {
                const settings = {from: 10,min: 10,max: 100,step: 1,range: true,to:500,view: "horizontal",hideTip: true,theme: "asdasdasd"};
                const correctedSettings = correctSettings(settings);
            ...
            it("return theme 'aqua' if 'theme' doesn't equal 'red' or 'aqua'", () => {
                const settings = {from: 101,min: 0,max: 100,step: 1,range: false,view: "horizontal",hideTip: true,theme: "asdasdasd"};
                const correctedSettings = correctSettings(settings);
            ...
            it("'step' equal 1 if 'step' less 0", () => {
                const settings = {from: 0,min: 0,max: 100,step: -13,range: false,view: "horizontal",hideTip: true,theme: "asdasdasd"};
                const correctedSettings = correctSettings(settings);
